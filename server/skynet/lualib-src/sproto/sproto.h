...
#define SPROTO_TFLOAT 3
#define SPROTO_TSTRUCT 4

// 容器相关
#define SPROTO_TARRAY 0x100 //数组
#define SPROTO_TIDICT 0x200 //整数做key的字典
#define SPROTO_TSDICT 0x300 //字符串做key的字典
#define SPROTO_ARRAY_MASK 0xff00
#define SPROTO_ARRAY_SHIFT 8

#define FLOAT_PRECISE 1000.0L
...
struct sproto_arg {
	...
	int array_type; //SPROTO_TARRAY,SPROTO_TIDICT,SPROTO_TSDICT
	int extra; // SPROTO_TINTEGER: decimal ; SPROTO_TSTRING 0:utf8 string 1:binary
};

typedef int (*sproto_callback)(struct sproto_arg *args);
